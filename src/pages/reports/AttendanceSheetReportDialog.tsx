...
export function AttendanceSheetReportDialog({
  open,
  onOpenChange,
}: {
  open: boolean
  ...
  const onGenerate = () => {
    ...
    generate(
      () => reportsApi.createAttendanceSheet({ group_subject_id: course.id, period_id: periodId, format }),
      ...
      <DialogContent>
        ...
        {!course ? (
          <p className="text-sm text-muted-foreground">
            Selecciona un curso activo en el encabezado para generar su reporte de asistencia.
          </p>
        ) : (
